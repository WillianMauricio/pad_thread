...
public class Main {
    ...
    static final int TAMANHO = 100000;
    static final int THREADS = 4;
    static final int BUSCA   = 99999;
    static final int TAMANHO_BUSCA = TAMANHO/THREADS;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < THREADS; i++) {
            new ArrayThread(array, BUSCA, anterior, anterior + TAMANHO_BUSCA).start();
